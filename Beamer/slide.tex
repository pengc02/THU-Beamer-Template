...
\bibliographystyle{acm}%设置参考文献格式，常见格式看这里https://blog.csdn.net/fendoubasaonian/article/details/88781456
\author{Peng Cheng}
\title{THU Beamer Theme}
\subtitle{Concluding Report for Summer Training}
...
\begin{frame}
    \begin{itemize}
        ...
        \item 五月：论文撰写 \cite{nation2001learning}
    \end{itemize}
\end{frame}
